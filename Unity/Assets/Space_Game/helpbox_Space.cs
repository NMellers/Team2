...
public class helpbox_Space : MonoBehaviour {
	...
	void OnGUI ()
	{
		...
		GUI.Box(new Rect( ((Screen.width-boxWidth)/2),((Screen.height-boxHeight)/2), boxWidth, boxHeight), "Space Shooter! \n Shoot and avoid enemeies \n Left/Right to move, Space to Shoot");
